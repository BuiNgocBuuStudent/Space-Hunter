...
public class MainMenu : MonoBehaviour
{
    ...
    private void OnPlaySceneLoad(Scene scene, LoadSceneMode mode)
    {
        if (scene.name == "PlayGame")
        {
            ...
            {
                case GameMode.easy:
                    setGameMode(spawnRateEnemy: 2.0f, spawnRateBoost: 30.0f, startTimeSpawnBoost: 10.0f, healAmount: 1, speedAmount: 2f, timeInterval: 100.0f);
                    break;
                case GameMode.normal:
                    setGameMode(spawnRateEnemy: 1.8f, spawnRateBoost: 31.0f, startTimeSpawnBoost: 10.0f, healAmount: 1, speedAmount: 2f, timeInterval: 90.0f);
                    break;
                case GameMode.hard:
                    setGameMode(spawnRateEnemy: 1.6f, spawnRateBoost: 32.0f, startTimeSpawnBoost: 10.0f, healAmount: 1, speedAmount: 2f, timeInterval: 80.0f);
                    break;
            }
        }
    }
